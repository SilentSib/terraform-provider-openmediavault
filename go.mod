module github.com/example/terraform-provider-openmediavault
...
replace golang.org/x/oauth2 => github.com/golang/oauth2 v0.21.0
...
replace google.golang.org/appengine => github.com/golang/appengine v1.6.8
...
replace gopkg.in/warnings.v0 => github.com/go-warnings/warnings v0.1.2
